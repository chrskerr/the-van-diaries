        ...
        <div class="inner">
            ...
            <div class="row gtr-200">
                <div class="col-6 col-12-medium">
                    <!-- Text -->
                    <h3>Text</h3>
                    <p>This is <b>bold</b> and this is <strong>strong</strong>. This is <i>italic</i> and this is <em>emphasized</em>. This is <sup>superscript</sup> text and this is <sub>subscript</sub> text. This is <u>underlined</u>, this is <code>code</code>, and this is a <a href="#">link</a>.</p>
                    ...
                    <h3>Icons</h3>
                    <ul class="icons">
                        <li><a href="#" class="icon brands feather-twitter"><span class="label">Twitter</span></a></li>
                        <li><a href="#" class="icon brands feather-facebook-f"><span class="label">Facebook</span></a></li>
                        <li><a href="#" class="icon brands feather-instagram"><span class="label">Instagram</span></a></li>
                        <li><a href="#" class="icon brands feather-github"><span class="label">Github</span></a></li>
                        <li><a href="#" class="icon brands feather-dribbble"><span class="label">Dribbble</span></a></li>
                        <li><a href="#" class="icon brands feather-tumblr"><span class="label">Tumblr</span></a></li>
                        <li><a href="#" class="icon brands feather-apple"><span class="label">Apple</span></a></li>
                        <li><a href="#" class="icon brands feather-windows"><span class="label">Windows</span></a></li>
                        <li><a href="#" class="icon brands feather-500px"><span class="label">500px</span></a></li>
                    </ul>
                ...
                <div class="col-6 col-12-medium">
                    ...
                    <ul class="actions">
                        <li><a href="#" class="button primary icon solid feather-search">Icon</a></li>
                        <li><a href="#" class="button icon solid feather-download">Icon</a></li>
                    </ul>
                    <ul class="actions">
                    ...
                    <form method="post" action="#">
                        <div class="row gtr-uniform">
                            ...
                            <!-- Break -->
                            <div class="col-12">
                                <textarea name="demo-textarea" id="demo-textarea" placeholder="Alpha beta gamma delta" rows="6" />
                            </div>
                            <!-- Break -->
                            <div class="col-12">
                                <ul class="actions">
